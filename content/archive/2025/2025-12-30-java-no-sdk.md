...
So I'm not really a Java programmer, but I can write Java since all university
coursework pretty much mandates it. But since I haven't written it in a while, I
didn't properly set it up when I rewrote
[my Neovim config](https://github.com/acheong08/nvim).
...
I didn't know how much time it'd take to solve the issue, and obviously spending
...
However, the combination of Java, VSCode, and Google Meet caused my CPU to run
...
After the interview, I solved the problem in barely 5 minutes. Shorter than the
amount of time it took to recover from all the crashes.
...
The correct solution might actually be to just get a better laptop, but
unfortunately I'm broke. So Neovim it is.
